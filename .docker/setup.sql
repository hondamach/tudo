...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM setup_complete WHERE completed = TRUE) THEN
		...
		VALUES
		('admin', '0188c451ed2f9b60b8ffed353b2fbee9208d543c04e26a6d61f2d2bdcc37cbf1', 'BOSS'),
		('user1', '5b09cfa5c2c8e6e468421251bfeb556c679d60ff37324065036bca54566c571d', 'Head of Security'),
		('user2', '0a8dc3467b9156a0347af4bcc5bbc837c1a5f64edb1d2a24792de08b8cf77298', 'Head of Management');
